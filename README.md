...
| Document | Purpose |
| --- | --- |
| `docs/architecture.svg` | One-page overview for a demo introduction: the agentic layer (analysis, remediation, verification, supervision) over the reliability layer (leases, idempotency, reconciliation, verification, drift detection), with human approval and the database. |
